...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React2.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React2.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React2.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime.jsx)(GridRoot, _extends({
      ...
      children: React2.Children.map(children, (child) => {
        if (React2.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QXQ3EF3E.js.map
